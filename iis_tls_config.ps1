...
$certThumbprint = (Import-PfxCertificate -FilePath 'mycert.pfx' -Password (ConvertTo-SecureString -String 'Password123' -AsPlainText -Force) -CertStoreLocation 'Cert:\LocalMachine\My').Thumbprint
